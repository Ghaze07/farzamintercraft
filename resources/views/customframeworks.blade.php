        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="image-container">
                    <img class="img-fluid" src="images/frame.png" alt="alternative">
                ...
                <div class="slider-container">
                    <div class="swiper-container card-slider">
                        <div class="swiper-wrapper"> 
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="card-image" src="images/zend.png" alt="alternative">
                                    <div class="card-body">
                                        
                                        <p class="testimonial-author">Zend Framework</p>
                                    </div>
                                </div>        
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
